...
다시 말해, 학생 개인에 맞춘 problem embedding $$\textbf{x'_t} = f_{enc_x}(\textbf{x}_1, \textbf{x}_2, ..., \textbf{x}_t)$$로 정의하였습니다. 
...
Input sequence가 들어오면 먼저 

1. Rasch model-based embedding을 만들고, 
